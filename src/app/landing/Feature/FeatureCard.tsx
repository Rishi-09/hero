...
export default function FeatureCard({ title, desc, type }: Props) {
  return (
    <div className="relative rounded-3xl bg-white/5 border border-white/10 backdrop-blur-xl p-8 h-[320px] overflow-hidden group">
      
      {/* Bottom Glow */}
      <div className="absolute bottom-0 left-0 w-full h-24 bg-green-500/20 blur-3xl" />
      ...
      {[
        ...
        >
          ...
          <motion.div
            ...
            className="absolute top-1/2 -translate-y-1/2 w-2.5 h-2.5 bg-white rounded-full shadow-[0_0_8px_rgba(255,255,255,0.9)]"
          />
        </div>
      ))}
    </div>
...
{type === "performance" && (
  <>
    ...
    <div className="absolute bottom-16 left-10 right-[77px] flex flex-col justify-between h-[100px]">

      {[0, 1, 2, 3, 4].map((i) => (
        <div
          key={i}
          className="relative h-[0.2px] bg-[#B6FF00]/40"
        >
          {/* Moving Dot */}
          <motion.div
            initial={{ left: "0%" }}
            ...
            className={`absolute top-1/2 -translate-y-1/2 w-3 h-3 rounded-full
              ${
                i === 0
                  ? "bg-yellow-400 shadow-[0_0_12px_rgba(255,255,0,0.8)]"
                  : i === 1
                  ? "bg-teal-400 shadow-[0_0_12px_rgba(0,255,200,0.8)]"
                  : i === 2
...
{type === "devices" && (
  <div className="relative w-[520px] h-[220px] flex items-center justify-center overflow-hidden">
    ...
    {/* Devices - STATIC */}
    <div className="relative w-[320px] h-[160px] z-5">
    ...
    <motion.div
      animate={{
        x: [-240, -200, 260, 220],  // completely outside devices
        opacity: [1, 0, 0, 1],
      }}
      transition={{
        duration: 6,
      ...
      className="absolute w-20 h-20 
        drop-shadow-[0_0_30px_rgba(124,255,0,0.9)]"
    >
...
{type === "wifi" && (
  <div className="relative w-48 h-48 mx-auto flex items-center justify-center">
    ...
    {/* Bottom Green Glow */}
    <div className="absolute bottom-2 w-40 h-24 
